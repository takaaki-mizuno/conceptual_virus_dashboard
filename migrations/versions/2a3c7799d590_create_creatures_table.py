...
def upgrade():
    op.create_table(
        ...
        sa.Column('id_address', sa.String(32), nullable=False),
        sa.Column('identity_key', sa.Unicode(64), nullable=False),
        sa.Column('last_ping_sent_at', sa.Integer, nullable=False),
        sa.Column('first_ping_sent_at', sa.Integer, nullable=False),
    )
    op.create_index('creatures_address', 'creatures', ['id_address'])
